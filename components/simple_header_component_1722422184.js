...
Vue.component("simple_header_component_1722422184", {
    ...
    <header id="header-section" class="w-full">
        <nav id="nav-bar" class="bg-opacity-20 backdrop-blur-lg bg-purple-100 border-b border-purple-200 py-4 dark:bg-opacity-20 dark:backdrop-blur-lg dark:bg-purple-900 dark:border-purple-700">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-6 mx-auto">
                <a id="logo-link" href="#" class="flex items-center">
                    ...
                    <span id="app-name" class="self-center text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-600 dark:from-pink-300 dark:to-purple-500">ProductScope - New Product Analysis</span>
                </a>
                <div id="menu-toggle-button" class="flex items-center lg:order-2">
                    <button id="collapse-button" data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 text-sm text-purple-500 rounded-lg lg:hidden hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-300 dark:text-purple-300 dark:hover:bg-purple-800 dark:focus:ring-purple-600" aria-controls="mobile-menu-2" aria-expanded="false">
